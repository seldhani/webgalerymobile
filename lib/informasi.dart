...
class _InformasiScreenState extends State<InformasiScreen> {
  ...
  void initState() {
    super.initState();
    fetchFotoWithKategori1(); // Mengambil foto berdasarkan kategori_id 1
  }

  // Fungsi untuk mengambil data foto berdasarkan kategori_id 1
  Future<void> fetchFotoWithKategori1() async {
    try {
      // Mengambil data posts berdasarkan kategori_id 1
      final postResponse = await http
          .get(Uri.parse('http://10.0.2.2:8000/api/posts/kategori/1'));
